...
//   // Load last check-in data from localStorage if it exists
//   useEffect(() => {
...
//             // Store the updated check-in data in localStorage
//             localStorage.setItem("lastCheckIn", JSON.stringify({ lat, long, time }));
